...
public class Employee {
    ...
    public static void main(String[] args) {
        ...
        var output = employees.stream()
                .collect(Collectors.groupingBy(deptName -> deptName.getDepartment().getName(),
                        Collectors.maxBy(Comparator.comparing(e -> e.yearlySalaries.values().stream()
        ...
        Comparator<Employee> byDepartment = Comparator.comparing(e -> e.getDepartment().getName());
        Comparator<Employee> bySal = Comparator.comparingDouble(Employee::getSalary).reversed();

        var sortingDeptNameThenSalDesc = employees.stream()
                .sorted(byDepartment.thenComparing(bySal))
                .toList();

        System.out.println("sortingDeptNameThenSalDesc: " + sortingDeptNameThenSalDesc);
